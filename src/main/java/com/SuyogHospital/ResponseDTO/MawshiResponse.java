...
public class MawshiResponse {
	 ...
	 private String employeeName;
		...
		public void setPunchingInTime(String punchingInTime) {
			this.punchingInTime = punchingInTime;
		}
		public String getDutyInTime() {
			return dutyInTime;
		}
		public void setDutyInTime(String dutyInTime) {
			this.dutyInTime = dutyInTime;
		}
		public String getPunchingOutTime() {
			return punchingOutTime;
		}
		public void setPunchingOutTime(String punchingOutTime) {
			this.punchingOutTime = punchingOutTime;
		}
		public String getDutyOutTime() {
			return dutyOutTime;
		}
		public void setDutyOutTime(String dutyOutTime) {
